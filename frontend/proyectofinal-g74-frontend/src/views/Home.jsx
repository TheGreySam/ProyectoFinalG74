            ...
            <div class="bg-white rounded-lg shadow-md p-4 mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                        <img src="https://m.media-amazon.com/images/I/51iE7XD13NL._AC_SX679_.jpg" alt="Producto 1" class="w-full h-40 object-cover"/>
                        <div class="p-4">
                            <h3 class="font-semibold text-lg">Auriculares Bluetooth PRO</h3>
                            ...
                            <div class="flex justify-between items-center mt-2">
                                ...
                                <button class="text-white bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded-md transition">
                    ...
                    {/* <!-- Producto 2 --> */}
                    <div class="bg-white border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                        <img src="https://m.media-amazon.com/images/I/71MFO2LGM5L.__AC_SY300_SX300_QL70_FMwebp_.jpg" alt="Producto 2" class="w-full h-40 object-cover"/>
                        <div class="p-4">
                            ...
                            <div class="flex justify-between items-center mt-2">
                                <p class="text-blue-600 font-bold">$89.99</p>
                                <button class="text-white bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded-md transition">
                                    <i class="fas fa-shopping-cart mr-1"></i> Añadir
                                </button>
                            </div>
                    ...
                    {/* <!-- Producto 3 --> */}
                    <div class="bg-white border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                        <img src="https://m.media-amazon.com/images/I/71rv+5yG+yL._AC_SL1500_.jpg" alt="Producto 3" class="w-full h-40 object-cover"/>
                        <div class="p-4">
                            <h3 class="font-semibold text-lg">Monitor 27" 4K Ultra HD</h3>
                            <div class="flex text-yellow-400 mt-1">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <span class="text-gray-500 ml-1 text-sm">(215)</span>
                            </div>
                            <div class="flex justify-between items-center mt-2">
                                <p class="text-blue-600 font-bold">$349.99</p>
                                <button class="text-white bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded-md transition">
                                    <i class="fas fa-shopping-cart mr-1"></i> Añadir
                                </button>
                            </div>
                ...
                <div class="text-center mt-4">
                    <a href="#" class="text-blue-600 hover:underline font-medium">Ver más recomendaciones</a>
                </div>
            </div>
